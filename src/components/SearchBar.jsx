...
const SearchBar = () => {
  return (
    <div className='flex justify-center  '>
        <form className='px-4 bg-white flex justify-center items-center rounded -mt-5 shadow-xl dark:bg-gray-800'>
        <label htmlFor="search" className='hidden md:flex text-lightBlue font-black text-2xl'><BsSearch/> </label>
        ...
        <button type='submit' className='bg-lightBlue text-white px-4 py-3 mx-5 font-bold rounded hidden md:flex'>Search</button>
        <button className='text-3xl md:hidden flex text-slate-500 dark:text-slate-50'><ion-icon name="funnel"></ion-icon></button>
        <button type='submit' className='bg-lightBlue text-white text-3xl px-4 py-3 mx-5 font-black rounded md:hidden'><BsSearch/> </button>
    </form>
    </div>
  )
}
