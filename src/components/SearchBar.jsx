...
const SearchBar = () => {
  return (
    <div className='flex justify-center  '>
        <form className=' px-4 bg-white flex justify-center items-center rounded -mt-8 shadow-xl'>
        <label htmlFor="search" className='flex text-lightBlue font-black text-2xl'><BsSearch/> </label>
        <input type="text" placeholder='Filter by titles,companies,expertise...' id='search' className='py-6 px-4 focus:outline-none border-r-2 border-gray md:w-72'/>
        <label htmlFor="search" className='flex text-lightBlue font-black text-2xl'><SlLocationPin/> </label>
        <input type="text" placeholder='Filter by location.' id='location' className='py-6 px-4 focus:outline-none border-r-2 border-gray md:w-72'/>
