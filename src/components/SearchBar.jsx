...
const SearchBar = () => {
  return (
    <div className='flex justify-center  '>
        ...
        <input type="text" placeholder='Filter by titles,companies,expertise...' id='search' className='py-6 px-4 focus:outline-none border-r-2 border-gray w-72'/>
        <label htmlFor="search" className='flex text-lightBlue font-black text-2xl'><SlLocationPin/> </label>
        <input type="text" placeholder='Filter by location.' id='location' className='py-6 px-4 focus:outline-none border-r-2 border-gray w-72'/>
